...
#    def __init__(self, root, transform=None, gt_transform=None, phase="test"):
        if phase == 'train':
    ...
    def __getitem__(self, idx):
        ...
        # img_path를 추가로 반환하여 원본 파일 이름을 사용할 수 있도록 함
        return img, gt, label, img_type, img_path # img_path 추가
